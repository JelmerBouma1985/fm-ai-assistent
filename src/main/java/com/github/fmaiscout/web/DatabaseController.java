...
import com.github.fmaiscout.db.CompetitionDatabaseService;
import com.github.fmaiscout.db.DatabaseLoadAllService;
...
public class DatabaseController {
    ...
    public List<Map<String, Object>> clubs(
        ...
        return clubs.findClubs(name, gender, nation, competition, limit).stream()
                .map(com.github.fmaiscout.db.ClubEntity::toApiMap)
                .toList();
    }
